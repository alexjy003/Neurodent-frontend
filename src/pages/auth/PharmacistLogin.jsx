      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-white py-8 px-4 shadow-lg sm:rounded-lg sm:px-10">
            ...
            <div>
              ...
              <div className="mt-1 relative">
                <input
                  ...
                  onChange={handleInputChange}
                  className="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md placeholder-gray-400 focus:outline-none focus:ring-yellow-600 focus:border-yellow-600 sm:text-sm pr-10"
          ...
          <div className="mt-2 text-center">
            <Link to="/role-selection" className="text-sm text-gray-500 hover:text-yellow-600 transition-colors duration-200">
