    ...
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <div className="flex justify-center">
          <div className="w-16 h-16 rounded-full overflow-hidden shadow-lg border-4 border-green-600">
            <img 
              src={doctorLogo} 
              alt="Doctor Logo" 
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-white py-8 px-4 shadow-lg sm:rounded-lg sm:px-10">
            ...
            <div>
              ...
              <div className="mt-1 relative">
                <input
                  ...
                  onChange={handleInputChange}
                  className="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md placeholder-gray-400 focus:outline-none focus:ring-green-600 focus:border-green-600 sm:text-sm pr-10"
            ...
            <div className="flex">
              ...
              <div className="ml-3">
                <p className="text-sm text-green-800">
                  <strong>For Medical Staff:</strong> Your account is managed by the admin. 
                  Contact administration if you're having trouble accessing your account.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="mt-4 text-center">
            <Link to="/login/admin" className="text-xs text-gray-400 hover:text-gray-600 transition-colors duration-200">
          ...
          <div className="mt-2 text-center">
            <Link to="/role-selection" className="text-sm text-gray-500 hover:text-green-600 transition-colors duration-200">
